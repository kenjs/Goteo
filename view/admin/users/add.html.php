...
<div class="widget">
    <form action="/admin/users/add" method="post">
        <p>
            <label for="user-user"><?php echo Text::_('Login'); ?>:</label><span style="font-style:italic;"><?php echo Text::_("Solo letras, números y guion '-'. Sin espacios ni tildes ni 'ñ' ni 'ç' ni otros caracteres que no sean letra, número o guión."); ?></span><br />
        ...
        <p>
            <label for="user-email"><?php echo Text::_('Email'); ?>:</label><span style="font-style:italic;"><?php echo Text::_('Que sea válido.'); ?></span><br />
