            ...
            */?>
            <div class="inner cf">
                <ul>
                    ...
                    <li><a href="<?= INTEGRATION_URL ?>/riyou_kiyaku_menu/">利用規約</a></li>
                    <li><a href="<?= INTEGRATION_URL ?>/syoutorihikihou/">特定商取引法に基づく表記</a></li>
                    <li><a href="<?= LOCALGOOD_WP_BASE_URL ?>/user_guide/">ユーザーガイド</a></li>
                    <li><a href="<?= INTEGRATION_URL ?>/privacypolicy/">プライバシーポリシー</a></li>
